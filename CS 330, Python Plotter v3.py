...
filename = "CS 330, Dynamic trajectory data.csv" 
...
for mov in movers:                  # for each mover
    ...
    for c in range(0, len(m.x)):    # Plot orientation data
        ...
        plt.plot(i, j, color='purple', linewidth=1) #, label="position") # plots position
...
plt.plot(0, 0 , color='purple', label='orientation')
